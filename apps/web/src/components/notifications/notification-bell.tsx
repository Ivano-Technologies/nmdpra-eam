...
export function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open ? (
        <div
          className="border-border bg-popover text-foreground absolute right-0 z-50 mt-2 w-[min(100vw-2rem,20rem)] max-h-[min(70vh,26rem)] overflow-hidden rounded-xl border shadow-xl shadow-black/15 dark:shadow-black/40"
          role="dialog"
